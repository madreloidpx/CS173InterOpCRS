<?php
	...
	$server->wsdl->addComplexType('courses_array', 'complexType','struct','all','',array('id'=>array('name'=>'id','type'=>'xsd:int'),'title'=>array('name'=>'title','type'=>'xsd:string'),'room'=>array('name'=>'room','type'=>'xsd:string'), 'units'=>array('name'=>'units','type'=>'xsd:int'), 'academic_year'=>array('name'=>'academic_year','type'=>'xsd:int')));
